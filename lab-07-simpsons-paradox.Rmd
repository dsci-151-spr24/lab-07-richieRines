...
***The study was most likely observational. The study was just observing the women, if it was an experimental study then there would have been some sort of treatment involved***

2.  How many observations are in this dataset?
    What does each observation represent?
    
***There are 1314 observations in the dataset. Each observation represents a woman in the study***
...
***There are `r ncol(Whickham)` variables. `outcome` and `smoker` are character data and `age` is numerical data.***
...
***I would expect smokers to have worse health and more deaths.***
...
***This is not what I expected at all. According to the visualizations, it seems that smokers have better health than non-smokers!***
...
***According to the plot, there are more dead smokers and alive smokers in each age category***
